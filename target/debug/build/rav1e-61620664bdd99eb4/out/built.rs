...
#[allow(dead_code)]
pub const RUSTC: &str = r"C:\\Users\\Jaskiran Kaur\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"C:\\Users\\Jaskiran Kaur\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustdoc.exe";
...
#[allow(dead_code)]
pub const FEATURES: [&str; 3] = ["THREADING", "WASM", "WASM_BINDGEN"];
#[doc=r#"The features as a comma-separated string."#]
#[allow(dead_code)]
pub const FEATURES_STR: &str = r"THREADING, WASM, WASM_BINDGEN";
#[doc=r#"The features as above, as lowercase strings."#]
#[allow(dead_code)]
pub const FEATURES_LOWERCASE: [&str; 3] = ["threading", "wasm", "wasm_bindgen"];
#[doc=r#"The feature-string as above, from lowercase strings."#]
#[allow(dead_code)]
pub const FEATURES_LOWERCASE_STR: &str = r"threading, wasm, wasm_bindgen";
#[doc=r#"The output of `C:\Users\Jaskiran Kaur\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.83.0 (90b35a623 2024-11-26)";
#[doc=r#"The output of `C:\Users\Jaskiran Kaur\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`; empty string if `C:\Users\Jaskiran Kaur\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V` failed to execute"#]
#[allow(dead_code)]
